...
!(function (u, d, s, c) {
        ...
        if ("object" == typeof e)
            for (var t in e)
                switch (t) {
                    ...
                    case "margin":
                        (e.margin *= 1),
                            (S.margin = (isNaN(e.margin) ? S : e).margin);
                        break;
                    case "wrap":
                        e.el && e.wrap && j(e.el);
                        break;
                    ...
                    case "alpha":
                        (S.alpha = !!e.alpha),
                            f.setAttribute("data-alpha", S.alpha);
                        break;
                    case "inline":
                        (S.inline = !!e.inline),
                            f.setAttribute("data-inline", S.inline),
                            S.inline &&
                                ((l = e.defaultColor || S.defaultColor),
                                (E = q(l)),
                                I(),
                                W(l));
                        break;
                    case "clearButton":
                        "object" == typeof e.clearButton &&
                            ...
                            (y.style.display = S.clearButton
                                ? "block"
                                : "none");
                        break;
                    case "clearLabel":
                        (S.clearLabel = e.clearLabel),
                            (y.innerHTML = S.clearLabel);
                        break;
                    case "closeButton":
                        ...
                        break;
                    case "closeLabel":
                        (S.closeLabel = e.closeLabel),
                            (g.innerHTML = S.closeLabel);
                        break;
                    case "a11y":
                        var a,
                            l,
    ...
    function N(e) {
        J(d, "click", e, function (e) {
            ...
            J(d, "input", e, function (e) {
                ...
                t.classList.contains("clr-field") &&
    ...
    function $() {
        return Array.from(f.querySelectorAll("input, button")).filter(function (
            e
        ) {
