                 ...
                 <div class="popup__form">
                     ...
                     <form action="#" class="form__wrapper">
                         ...
                         <div class="login__access">
                             <a href="#" class="btn btn-outline"><img
                                     src="{{ asset('client-frontend') }}/assets/images/google.png" alt="google" />Sign
                                 up with Google</a>
                             <a href="#" class="btn btn-outline"><img
                                     src="{{ asset('client-frontend') }}/assets/images/facebook.png"
                 ...
                 <div class="popup__form">
                     <div class="popup__logo">
                         <a href="home.html"><img
                                 src="{{ asset('client-frontend') }}/assets/images/logo/logo-white.png"
                                 alt="logo" /></a>
                     </div>
                     <div class="popup__bg">
                         <img src="{{ asset('client-frontend') }}/assets/images/popup/p-bg-02.jpg" alt="popup-bg" />
