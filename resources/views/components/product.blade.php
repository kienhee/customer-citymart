 <div class="product-card">
     <div class="product__image__wrapper">
         ...
         <div class="product__actions">
             ...
             {{-- <a href="#" data-bs-toggle="modal" data-bs-target="#prod__preview-{{ $id }}"
                 class="action__btn">
             ...
             {{-- <a href="#" class="action__btn">
                 <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
                     <path d="M10 9.33329L13.3333 5.99996L10 2.66663" stroke="#252522" stroke-linecap="round"
     ...
     <div class="product__content">
         ...
         <div class="product__bottom d-block">
             ...
             <div class="cart__action__btn ">
                 <div class="cart__btn ">
                     <a href="#" class="btn btn-outline w-100">Thêm vào giỏ</a>
                 </div>
                 <div class="quantity cart__quantity w-100">
