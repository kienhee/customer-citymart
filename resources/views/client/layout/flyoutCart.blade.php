        ...
        <div class="flyout__flip">
            <div class="flyout__inner">
                ...
                <div class="cart__items">
                    ...
                    <div class="shopping-card">
                        <a href="#" class="shopping-card__image">
                            <img src="{{ asset('client-frontend') }}/assets/images/cart/cart-03.png" alt="cart-product" />
                        </a>
                        <div class="shopping-card__content">
                            <div class="shopping-card__content-top">
                                <h5 class="product__title">
                    ...
                    <div class="shopping-card">
                        <a href="#" class="shopping-card__image">
                            <img src="{{ asset('client-frontend') }}/assets/images/cart/cart-04.png" alt="cart-product" />
                        </a>
                        <div class="shopping-card__content">
                            <div class="shopping-card__content-top">
                                <h5 class="product__title">
