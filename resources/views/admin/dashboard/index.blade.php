            ...
            <div class="card">
                <div class="d-flex align-items-end row">
                    ...
                    <div class="col-4 pt-3 ps-0">
                        <img src="{{ asset('admin-frontend') }}/assets/img/illustrations/prize-light.png" width="90"
                        ...
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between">
                                <div class="avatar flex-shrink-0">
                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/unicons/wallet-info.png"
                ...
                <div class="col-lg-6 col-md-3 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between">
                                <div class="avatar flex-shrink-0">
                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/unicons/briefcase.png"
                                        alt="Credit Card" class="rounded" />
                                </div>
                                <div class="dropdown">
                        ...
                        <div class="card-body">
                            <div class="report-list">
                                <div class="report-list-item rounded-2 mb-3">
                                    <div class="d-flex align-items-start">
                                        <div class="report-list-icon shadow-sm me-2">
                                            <img src="{{ asset('admin-frontend') }}/assets/svg/icons/paypal-icon.svg"
                                ...
                                <div class="report-list-item rounded-2 mb-3">
                                    <div class="d-flex align-items-start">
                                        <div class="report-list-icon shadow-sm me-2">
                                            <img src="{{ asset('admin-frontend') }}/assets/svg/icons/shopping-bag-icon.svg"
                                ...
                                <div class="report-list-item rounded-2">
                                    <div class="d-flex align-items-start">
                                        <div class="report-list-icon shadow-sm me-2">
                                            <img src="{{ asset('admin-frontend') }}/assets/svg/icons/wallet-icon.svg"
                ...
                <div class="col-12 col-sm-6 col-md-3 col-lg-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between">
                                <div class="avatar flex-shrink-0">
                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/unicons/cc-warning.png"
                                        alt="Credit Card" class="rounded" />
                                </div>
                                <div class="dropdown">
                    ...
                    <table class="table text-nowrap">
                        ...
                        <tbody class="table-border-bottom-0">
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('admin-frontend') }}/assets/img/products/oneplus-lg.png"
                                ...
                                <td>
                                    <span class="badge bg-label-primary rounded-pill badge-center p-3 me-2"><i
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('admin-frontend') }}/assets/img/products/magic-mouse.png"
                                ...
                                <td>
                                    <span class="badge bg-label-warning rounded-pill badge-center p-3 me-2"><i
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('admin-frontend') }}/assets/img/products/imac-pro.png"
                                            alt="Apple" height="32" width="32" class="me-2" />
                                        <div class="d-flex flex-column">
                                ...
                                <td>
                                    <span class="badge bg-label-info rounded-pill badge-center p-3 me-2"><i
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('admin-frontend') }}/assets/img/products/note10.png"
                                            alt="Samsung" height="32" width="32" class="me-2" />
                                        <div class="d-flex flex-column">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('admin-frontend') }}/assets/img/products/iphone.png"
                                            alt="Apple" height="32" width="32" class="me-2" />
                                        <div class="d-flex flex-column">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('admin-frontend') }}/assets/img/products/mi-tv.png"
                                            alt="Xiaomi" height="32" width="32" class="me-2" />
                                        <div class="d-flex flex-column">
                                ...
                                <td>
                                    <span class="badge bg-label-danger rounded-pill badge-center p-3 me-2"><i
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('admin-frontend') }}/assets/img/products/logitech-mx.png"
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        <small class="text-muted">You have done <span class="fw-medium">57.6%</span> more
                            sales.<br />Check your new badge in
                            your profile.</small>
                        <div>
