        ...
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-header  d-flex align-items-center justify-content-between">
                    <h5 class="card-title mb-0">Cập nhật bảng màu</h5>
                ...
                <!-- Account -->
                <div class="card-body">
                    <form action="{{ route('dashboard.colors.update', $color->id) }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="row ">
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <input class="form-control  coloris @error('code') is-invalid @enderror " type="text"
                                    id="code" name="code" value="{{ old('code') ?? $color->code }}"
                                    placeholder="Mã hex" autofocus data-coloris />
                                @error('code')
                                    <p class="text-danger my-1">{{ $message }}</p>
                                @enderror
