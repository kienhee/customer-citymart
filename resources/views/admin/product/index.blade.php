...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header border-bottom d-flex align-items-center justify-content-between">
            ...
            <a href="{{ route('dashboard.products.add') }}" class="btn btn-outline-primary">
        ...
        <form method="GET" class="mx-3 mb-4 mt-4">
            <div class="row ">
                ...
                <div class="col-md-6 col-lg-12 mb-2 text-md-end">
                    <a href="{{ route('dashboard.products.index') }}" class="btn btn-outline-secondary">Đặt lại </a>
                        ...
                        @foreach ($products as $item)
                            <tr>
                                <td class="px-0 text-center">
                                    <a href="{{ route('dashboard.products.edit', $item->id) }}" title="Click xem thêm"
                                ...
                                <td>
                                    <a href="{{ route('dashboard.products.edit', $item->id) }}" style="color: inherit    "
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                                href="{{ route('dashboard.products.edit', $item->id) }}"><i
                                            ...
                                            @if ($item->trashed() == 1)
                                                <form class="dropdown-item"
                                                    action="{{ route('dashboard.products.restore', $item->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('delete')
                                            ...
                                            @endif
                                            <form class="dropdown-item"
                                                action="{{ $item->trashed() ? route('dashboard.products.force-delete', $item->id) : route('dashboard.products.soft-delete', $item->id) }}"
                                                method="POST"
