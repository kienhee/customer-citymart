...
<html lang="en" class="light-style layout-wide customizer-hide" dir="ltr" data-theme="theme-default"
    data-assets-path="{{ asset('admin-frontend') }}/assets/" data-template="vertical-menu-template">
...
<head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('admin-frontend') }}/assets/vendor/css/pages/page-misc.css" />
